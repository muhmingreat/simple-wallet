...
const ServiceCard = ({ color, title, icon, subtitle }) => (
  ...
  justify-start items-center white-glassmorphism
    ...
    gradient-bg-services">
      ...
      md:p-20 py-12 px-4">
        <div className=" flex-1 flex flex-col justify-start">
          ...
          sm:text-5xl py-2 text-gradient'> Services that we <br/>
          continue to inprove</h1>
        </div>
      </div>
      <div className='flex-1 flex flex-col text-white justify-start items-center'>
        <ServiceCard
          color='bg-[#2952E3]'
          ...
          icon={<BsShieldFillCheck fontSize={21}/>}
            ...
            we always maintain privacy and maintain the quality
            of our product'/>
        <ServiceCard
          color='bg-[#8945F8]'
